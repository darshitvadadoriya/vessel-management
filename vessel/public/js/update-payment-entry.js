$(document).ready(function () {
    ...
    function add_row() {
        ...
        $("#"+party_id).change(function(){
            ...
            if(customer_name==""){
                get_bank_account(function(data){
                    console.log("DATA OF CUSTOMER IS NOT=====================================");
                    console.log(data);
                    $.each(data,function(i,account){
                        $("#"+account_id).append(`<option value="${account.name}">${account.name}</option>`)
                    })
                ...
                console.log("GET DATA OF CUSTOMER IS GETTED*********************************");
                $("#"+account_id).empty()
    ...
    $("#save").click(function(){
        ...
        var currentAccountList = JSON.stringify(new_account_lst.slice());
        console.log(currentAccountList);
        if (currentAccountList === old_account_lst) {
            console.log('Table has been updated.');
            // Here you can perform actions or set flags indicating the update
        } else {
            console.log('Table has not been updated.');
        }
        ...
        console.log(diff_account_lst);

        // update_payment_entry()
        // function update_payment_entry(){
        //     $.ajax({
        //         url: "/api/resource/Journal Entry/"+payment_entry_id,
        //         type: "PUT",
        //         dataType: "json",
